...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      <div className="bg-gradient-to-r from-red-500 via-white to-red-500 text-black py-2 text-center text-sm">
        <p className="flex flex-col items-center justify-center">
          ...
          <span className="mt-1 flex items-center font-bold">
            Made with the coolest, most powerful DX AI on the planet
            <svg
      ...
      <footer className="bg-gradient-to-r from-secondary to-primary text-primary-foreground p-4 mt-8">
        <div className="max-w-7xl mx-auto text-center">© 2023 Zach Miller Tech Consulting. All rights reserved.</div>
      </footer>
    </div>
  )
}
